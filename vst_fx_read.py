...
vstdata = read_vst2_data(song_file)
fourid = vstdata['plugin']['fourid']
vst_chunk = vstdata['data']
print(vst_chunk)

output_data, global_vars, pointers, pointset = datadef.parse(BytesIO(vst_chunk), './vst2_chunk/'+str(fourid)+'.datadef')
